...
Namespace Generic
    ...
    ''' </summary>
    ''' --------------------------------------------------------------------------------
    Public Class ObjectReference(Of T As IDatabaseObject)
        ...
        Public Sub New( _
            ...
            MyBase.New(objCollection.ParentDatabase, objCollection)
        ...
        Public Sub New( _
            ...
            MyBase.New(objDatabase, objCollection)
        ...
        ''' </summary>
        ''' --------------------------------------------------------------------------------
        Public Overridable Shadows Property [Object]() As T
            Get

                Return DirectCast(MyBase.Object, T)
        ...
        '''' </example>
        '''' --------------------------------------------------------------------------------
        'Public Shadows Property DistinctValue() As TDistinct
        '    Get

        '        Return CType(MyBase.DistinctValue, TDistinct)

        '    End Get

        '    Set(ByVal value As TDistinct)

        '        MyBase.DistinctValue = value
