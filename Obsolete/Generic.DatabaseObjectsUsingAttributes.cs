...
namespace DatabaseObjects.Generic
{
	...
	/// </summary>
	[Obsolete("Use DatabaseObjects.Generic.DatabaseObjects instead, it provides the same functionality.")]
    public abstract class DatabaseObjectsUsingAttributes<T> : Generic.DatabaseObjects<T> where T : IDatabaseObject
	{
		/// --------------------------------------------------------------------------------
		/// <summary>
