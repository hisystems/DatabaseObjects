...
Namespace Generic
    ...
    ''' </summary>
    <Obsolete("Use DatabaseObjects.Generic.DatabaseObjectsListKeyed instead, it provides the same functionality.")> _
    Public MustInherit Class DatabaseObjectsListKeyedUsingAttributes(Of T As IDatabaseObject, TKey)
        Inherits Generic.DatabaseObjectsListKeyed(Of T, TKey)
