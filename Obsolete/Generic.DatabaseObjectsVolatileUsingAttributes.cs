...
namespace DatabaseObjects.Generic
{
	...
	/// </summary>
	[Obsolete("Use DatabaseObjects.Generic.DatabaseObjectsVolatile instead, it provides the same functionality.")]
    public abstract class DatabaseObjectsVolatileUsingAttributes<T> : Generic.DatabaseObjectsVolatile<T> where T : IDatabaseObject
	{
		/// --------------------------------------------------------------------------------
		/// <summary>
		...
		/// </param>
		/// --------------------------------------------------------------------------------
		protected DatabaseObjectsVolatileUsingAttributes(Database objDatabase, object objData)
