...
namespace DatabaseObjects
{
	...
	public interface IDatabaseObjects
	{
		...
		/// </example>
		/// --------------------------------------------------------------------------------
		SQL.FieldValueAutoAssignmentType DistinctFieldAutoAssignment();
		...
		/// </example>
		/// --------------------------------------------------------------------------------
		SQL.SQLSelectOrderByFields OrderBy();
		...
		/// </example>
		/// --------------------------------------------------------------------------------
		SQL.SQLSelectTableJoins TableJoins(SQL.SQLSelectTable objPrimaryTable, SQL.SQLSelectTables objTables);
	}
}
